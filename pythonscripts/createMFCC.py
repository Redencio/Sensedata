...
for file in onlyfiles:
    if not file == '.DS_Store':
        ...
        (rate,sig) = wav.read("/Volumes/LstarR HDD/Redencio2013-2014/noise_10sec/"+file)
...
for file in mypath_speech:
    if not file == '.DS_Store':
        (rate,sig) = wav.read("/Users/Capodit3/Documents/Sensedata/sense-os project2/noiseSound/"+file)
