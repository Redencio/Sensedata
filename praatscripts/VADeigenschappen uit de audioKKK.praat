form Read multiple files
	sentence source_directory /Volumes/LstarR HDD/Redencio2013-2014/speech corpus48_wavs4_5_sec3/
...
for ifile to number_of_files 
	...
	#printline file 'file_name$' ; 'total_energy';'total_F';'total_SFM'; 1; 

#--------------------------------------------------
	#select Strings list
    #file_name$ = Get string... ifile
    #Read from file... 'source_directory$'/'file_name$'
    #file_name$ = file_name$ #file_name$ - ".TextGrid"
    outputName$ = "'source_directory$'/'file_name$'.VQ"
    voiceReportName$ = "'source_directory$''file_name$'"
    wavFile$ = file_name$ 
    Read from file... 'source_directory$'/'wavFile$'
    ...
    select IntensityTier 'object_name$'
    ...
    Rename... 'object_name$'_beforetracking
    Track... 3 500 1485 2475 3850 4950 1 1 1
    Rename... 'object_name$'_aftertracking
    ...
    select Sound 'object_name$'
    plus LPC 'object_name$'
    Filter (inverse)

    Rename... 'object_name$'_Source
   ...
   Remove
    ...
    select Sound 'object_name$'_Source
...
#   To Pitch (ac)... timeStep minPitch 15 0.01 0.01 0.0 0.01 0.0 0.0 maxPitch
    ...
    select Sound 'object_name$'_Source
    plus Pitch 'object_name$'_Source
    To PointProcess (cc)
    ...
    ##############################
    select PointProcess 'object_name$'_Source
    ...
    ##############################
    select Sound 'object_name$'_Source
    plus PointProcess 'object_name$'_Source
...
;    meanHNR = extractNumber(voiceReport$, "Mean harmonics-to-noise ratio: ")
    ...
    ##########################################
    select Pitch 'object_name$'_Source
    ...
    ################################################
        ...
        select Formant 'object_name$'_aftertracking
...
;       endif
    ...
    ########################################################
       ...
       # Slope analysis
       select Ltas 'object_name$'_Source_part
       Compute trend line... 600 4000
       select Ltas 'object_name$'_Source_part_trend
      ...
      endT = t + 0.05
       ...
       select Sound 'object_name$'_part
       Remove
       select Spectrum 'object_name$'_part
       Remove
       select Ltas 'object_name$'_part
       Remove
       select Sound 'object_name$'_Source_part
       Remove
       select Spectrum 'object_name$'_Source_part
       Remove
       select Ltas 'object_name$'_Source_part
       Remove
       select Ltas 'object_name$'_Source_part_trend
